...
**[sjs_service.py](https://github.com/faiwongyip/shenjianshou_api/blob/master/sjs_service.py "sjs_service.py")**：按照文档编写的几个功能，还没补齐全，留个坑。

**[sjs_api.py](https://github.com/faiwongyip/shenjianshou_api/blob/master/sjs_api.py "sjs_api.py")**：根据需求拓展sjs_service。
